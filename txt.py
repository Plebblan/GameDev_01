        ...
        if state != "playing":
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    elif state == "score" and event.key == pygame.K_SPACE:
                        # RESET GAME
                        state = "playing"
                        health = 5
                        score = 0
            ...
            if state == "death_anim":
                ...
                hint = font.render("Press any key to continue", True, (220, 220, 220))
                screen.blit(hint, hint.get_rect(center=(chosen_width//2, chosen_height//2 + 80)))
